...
function Inbox() {
    return (
        <div className='w-full h-full gap-y-1 flex items-center justify-center flex-col'>
            ...
            <p className='text-sm text-[#8e8e8e]'>Bir arkadaşına veya gruba gizli fotoğraflar ve mesajlar gönder</p>
            <div className='mt-3'>
